...
export function getPowwowHandlers(converter) {
    return {
        'al': (args, options) => converter.convertAliasPowwow(args, options),
        'alias': (args, options) => converter.convertAliasPowwow(args, options),
        'ac': (args, options) => converter.convertActionPowwow(args, options),
        'action': (args, options) => converter.convertActionPowwow(args, options),
        'setvar': (args, options) => converter.convertVarPowwow(args, options),
        ...
        'beep': () => ({ text: `#BELL` }),
        'bi': (args, options) => converter.powwowHandlers['bind'](args, options),
        'bind': (args, options) => converter.convertBindPowwow(args, options),
        'emu': (args, options) => converter.powwowHandlers['emulate'](args, options),
        ...
        'option': (args, options) => {
            ...
            if (match) {
                ...
                if (name.toLowerCase() === 'autoprint') {
                    converter.state.powwow.autoprint = (op === '+');
                    return { text: `#NOP OPTION autoprint set to ${op === '+' ? 'ON' : 'OFF'}` };
                }
            }
        ...
        'quit': () => ({ text: `#END` }),
        'exe': (args, options) => ({ text: converter.processCommands(converter.convertSyntax(args, options), options) })
    };
}

export function getJMCHandlers(converter) {
    return {
        'al': (args, options) => converter.convertAliasJMC(args, options),
        'alias': (args, options) => converter.convertAliasJMC(args, options),
        'ac': (args, options) => converter.convertActionJMC(args, options),
        'action': (args, options) => converter.convertActionJMC(args, options),
        'var': (args, options) => converter.convertVarJMC(args, options),
        ...
        'sub': (args, options) => converter.convertSubstituteJMC(args, options),
        ...
        'antisub': (args, options) => ({ text: `#ANTISUBSTITUTE {${converter.convertSyntax(converter.cleanJMCArgs(args), options)}}` }),
        'unsubstitute': (args, options) => ({ text: `#UNSUB {${converter.convertSyntax(converter.cleanJMCArgs(args), options)}}` }),
        'unsub': (args, options) => ({ text: `#UNSUB {${converter.convertSyntax(converter.cleanJMCArgs(args), options)}}` }),
        ...
        'unali': (args, options) => ({ text: `#UNALIAS {${converter.convertSyntax(converter.cleanJMCArgs(args), options)}}` }),
        'unaction': (args, options) => ({ text: `#UNACT {${converter.convertSyntax(converter.cleanJMCArgs(args), options)}}` }),
        'unac': (args, options) => ({ text: `#UNACT {${converter.convertSyntax(converter.cleanJMCArgs(args), options)}}` }),
        'unvar': (args, options) => ({ text: `#UNVAR {${converter.convertVarName(converter.cleanJMCArgs(args))}}` }),
        'showme': (args, options) => ({ text: `#SHOWME {${converter.convertSyntax(converter.cleanJMCArgs(args), options)}}` }),
        'output': (args, options) => ({ text: `#SHOWME {${converter.convertSyntax(converter.cleanJMCArgs(args), options)}}` }),
        'bell': () => ({ text: `#BELL` }),
        'break': () => ({ text: `#BREAK` }),
        ...
        'wt': (args, options) => ({ text: `#DELAY {${converter.cleanJMCArgs(args)}}` }),
        'echo': (args, options) => {
            if (args.toLowerCase() === 'on') return { text: `#CONFIG {VERBOSE} {ON}` };
            if (args.toLowerCase() === 'off') return { text: `#CONFIG {VERBOSE} {OFF}` };
            return { text: `#SHOWME {${converter.convertSyntax(args, options)}}` };
        },
        'quit': () => ({ text: `#END` }),
        'zap': () => ({ text: `#ZAP` }),
        ...
        'verbat': (args, options) => {
            ...
            return { text: `#NOP JMC VERBAT: #verbat ${args}` };
        },
        'colon': (args, options) => {
            return { text: `#NOP JMC COLON: #colon ${args}` };
        },
        'comment': (args, options) => {
            return { text: `#NOP JMC COMMENT character set to: ${args}` };
        },
        'nop': (args, options) => ({ text: `#NOP JMC NOP: ${args}` }),
        ...
        'cr': () => ({ text: `#SEND {\n}` }),
        'daa': (args, options) => ({ text: `#NOP DAA/HIDE/WHISPER (Secure send) partially supported: #SEND {${args}}` }),
        'hide': (args, options) => ({ text: `#NOP DAA/HIDE/WHISPER (Secure send) partially supported: #SEND {${args}}` }),
        'whisper': (args, options) => ({ text: `#NOP DAA/HIDE/WHISPER (Secure send) partially supported: #SEND {${args}}` }),
