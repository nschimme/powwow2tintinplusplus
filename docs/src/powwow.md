...
<p class="text-center text-gray-400 mb-8">Documentation last modified Oct 09, 2007</p>
...
<p>does exactly what you expect: insert "Roėntgen" on the input line ( ė is the ASCII char (octal)353 or (decimal)234 ) as if you typed it (of course you could also type the first few chars of the name then hit TAB if that name is already in the word completion list...).</p>
</div>
